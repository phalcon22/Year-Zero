    ...
    public void SendMessage(int i)
    {
        ...
        switch (i)
        {
            case 0:
                ...
                FindFirstObjectByType<AudioManager>().PlaySound("NotEnoughEnergy");
                break;
            case 1:
                message = "You don't have enough ore";
                FindFirstObjectByType<AudioManager>().PlayRandomSound(new []{"NotEnoughOre","NotEnoughOre2"} );
                break;
            case 2:
                message = "You don't have enough food";
                FindFirstObjectByType<AudioManager>().PlaySound("NotEnoughFood");
                break;
            case 3:
            ...
            default:
                ...
                FindFirstObjectByType<AudioManager>().PlayRandomSound(new []{"NotEnoughPop1","NotEnoughPop2"} );
                break;
        }
